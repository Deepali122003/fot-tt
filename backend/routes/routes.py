...
APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxkslo9MmgLhF2UVPi5lgrUhF-l_XcO5ahwPVeX-Tmxphy-z2_YsiYbGotJjV_25laj/exec"
...
def build_sheet_data(slot, db=None):
    ...
    "department":      slot.get("faculty_department", ""),
